    ...
    */
    (function() {
        ...
        for (B = H.length; l < B; ++l)(function() {
            ...
            g.src = "https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/--1-- lang-" + encodeURIComponent(H[l]) + ".js";
            N.insertBefore(g, N.firstChild)
        })(H[l]);
        for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l) F.push("https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/--1--skins/" + encodeURIComponent(P[l]) + ".css");
        F.push("https://cdn.jsdelivr.net/gh/google/code-prettify@master/loader/--1-- prettify.css");
        (function(g) {
            function r(l) {
                if (l !== x) {
